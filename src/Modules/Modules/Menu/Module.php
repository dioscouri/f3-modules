...
class Module extends \Modules\Abstracts\Module
{
    ...
    public function prepareMenu()
    {
        if (empty($this->list)) {
            ...
            $this->list = (new \Admin\Models\Navigation)->emptyState()->setState('filter.root', false)->setState('filter.published', true)->setState('filter.tree', $this->model->{'details.selected-menu'})->setState('order_clause', array( 'tree'=> 1, 'lft' => 1 ))->getList();
        }
